...
<body>
     ...
     <img src="li_home.jpg" height="370" width=100%>
       ...
       <div style="margin-left:40px; margin-top:20px;">
        ...
        <font size="4">Contact Us</font> <br>

        LIBRARY MANAGEMENT SYSTEM <br>

         Mobile: +918697323722 <br>

         Email : binita@absinfotech.in, suvalinadas7878@gmail.com, apaurangabad121@gmail.com <br>

        Website: www.lmsprojects.com <br>
       </div>
